...
const [user, setUser] = useState("");
  useEffect(() => {
    ...
    if (userCookie != null) setUser(JSON.parse(userCookie)); // استخدام الكوكيز بدلاً من localStorage
  }, []);
    ...
    <div className="flex items-center justify-center min-h-screen bg-gray-300">
      <div className="w-full max-w-7xl p-10 rounded-3xl shadow-2xl bg-white/90 backdrop-blur-sm ">
        <div className="text-center">
          ...
          <button className="mt-6 bg-blue-600 text-white hover:bg-blue-700 py-3 px-6 rounded-xl shadow-lg transform hover:scale-105 transition-all duration-300 flex items-center justify-center mx-auto space-x-2">
        ...
        <div className="mt-12 bg-gradient-to-br from-blue-50 to-blue-200 p-8 rounded-2xl shadow-inner">
          <h2 className="text-2xl font-bold text-gray-700 mb-6 flex items-center justify-center space-x-3">
            <FaCircleInfo size={24} className="text-blue-600" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              <div key={index} className="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-all duration-300 transform hover:-translate-y-2">
                <div className="flex items-center mb-3 space-x-3 border-b border-blue-100 pb-3">
                  {item.icon}
